...
summary: "A multi-language fitness platform for dog owners - web, mobile, and admin dashboard - serving content in 6 languages"
description: "Multi-language dog fitness platform architecture across web, mobile, backend APIs, and offline sync."
stack:
  - React Native
