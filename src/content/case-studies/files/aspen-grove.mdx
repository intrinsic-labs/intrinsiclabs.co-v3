...
stack:
  ...
  - WatermelonDB
  - Offline-first sync
summary: An LLM interface that treats conversations as explorable trees, not linear chats
description: An exploration-first mobile AI loom interface with provenance-focused architecture.
