...
stack:
  ...
  - Salesforce
  - Expo SQLite
summary: A mobile app prototype to replace Salesforce Mobile Geopointe for GFiber's door-to-door sales team
description: A mobile app prototype to replace Salesforce Mobile Geopointe for GFiber's door-to-door sales team
...
### Architecture
GFBR follows **strict clean architecture** with layer boundaries enforced by ESLint — not just documented, automated. Domain cannot import infrastructure, interface cannot import infrastructure directly, etc. Everything flows through typed ports and adapters.
...
### Status
React Native Prototype built against developer Salesforce & Okta. Designed for a 250-person national D2D sales team. Pitching for full-time development role to deploy team-wide.
